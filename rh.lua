...
--Settings
local collectDelay = .1 --Delay for each gem tp (There's also a randomization on top of this delay of about .1-.2 seconds)
...
local limit = 4000000 --Kicks you from the game at X gems (Idk what a good limit is, I don't play this game, it may be way higher / lower than the one provided, no fucking idea)
